...
public abstract class DebuggerArmourItem extends Item {
	public static ArmorMaterial ARMOR_MATERIAL = new ArmorMaterial(70, Map.of(ArmorType.BOOTS, 5, ArmorType.LEGGINGS, 8, ArmorType.CHESTPLATE, 10, ArmorType.HELMET, 5, ArmorType.BODY, 10), 15,
			DeferredHolder.create(Registries.SOUND_EVENT, Identifier.parse("block.big_dripleaf.fall")), 4f, 0.1f, TagKey.create(Registries.ITEM, Identifier.parse("mintyirlplanets:debugger_armour_repair_items")),
			ResourceKey.create(EquipmentAssets.ROOT_ID, Identifier.parse("mintyirlplanets:debugger_armour")));
