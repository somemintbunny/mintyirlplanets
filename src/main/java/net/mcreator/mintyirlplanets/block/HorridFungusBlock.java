...
import net.mcreator.mintyirlplanets.procedures.HorridFungusOnTickUpdateProcedure;
...
public class HorridFungusBlock extends Block {
	...
	public void randomTick(BlockState blockstate, ServerLevel world, BlockPos pos, RandomSource random) {
		...
		HorridFungusOnTickUpdateProcedure.execute(world, pos.getX(), pos.getY(), pos.getZ());
	}
}