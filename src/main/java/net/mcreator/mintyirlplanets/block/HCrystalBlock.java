...
import net.mcreator.mintyirlplanets.procedures.HCrystalNeighbourBlockChangesProcedure;
import net.mcreator.mintyirlplanets.procedures.DelProcedure;
...
public class HCrystalBlock extends Block {
	...
	public ItemStack getCloneItemStack(LevelReader world, BlockPos pos, BlockState state, boolean includeData, Player entity) {
		return new ItemStack(MintyirlplanetsModItems.HELIUM_SHARD.get());
	}
	...
	public void tick(BlockState blockstate, ServerLevel world, BlockPos pos, RandomSource random) {
		...
		DelProcedure.execute(world, pos.getX(), pos.getY(), pos.getZ());
	}
