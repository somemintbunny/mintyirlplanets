...
public class MintyirlplanetsModTabs {
	...
	public static final DeferredHolder<CreativeModeTab, CreativeModeTab> MARS_BLOCKS = REGISTRY.register("mars_blocks",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.mintyirlplanets.mars_blocks")).icon(() -> new ItemStack(MintyirlplanetsModBlocks.FERROUS_SAND.get())).displayItems((parameters, tabData) -> {
				...
				tabData.accept(MintyirlplanetsModBlocks.ROCKY_ALUMINEUM_BLOCK.get().asItem());
				tabData.accept(MintyirlplanetsModBlocks.CHLORITE.get().asItem());
				tabData.accept(MintyirlplanetsModBlocks.MOSSY_MULCH.get().asItem());
				tabData.accept(MintyirlplanetsModBlocks.SILICON_MULCH.get().asItem());
				...
				tabData.accept(MintyirlplanetsModBlocks.UNCONSIUM_SAPLING.get().asItem());
				tabData.accept(MintyirlplanetsModBlocks.SUBCONSIUS_WOOD.get().asItem());
				tabData.accept(MintyirlplanetsModBlocks.SUBCONSIUS_LOG.get().asItem());
				tabData.accept(MintyirlplanetsModBlocks.SUBCONSIUS_PLANKS.get().asItem());
				tabData.accept(MintyirlplanetsModBlocks.SUBCONSIUS_LEAVES.get().asItem());
				tabData.accept(MintyirlplanetsModBlocks.STRIPPED_SUBCONSIUS_LOG.get().asItem());
				tabData.accept(MintyirlplanetsModBlocks.STRIPPED_SUBCONSIUS_WOOD.get().asItem());
				tabData.accept(MintyirlplanetsModBlocks.SUBCONSIUS_STAIRS.get().asItem());
				tabData.accept(MintyirlplanetsModBlocks.SUBCONSIUS_SLAB.get().asItem());
				tabData.accept(MintyirlplanetsModBlocks.SUBCONSIUS_TRAPDOOR.get().asItem());
				tabData.accept(MintyirlplanetsModBlocks.SUBCONSIUS_PRESSURE_PLATE.get().asItem());
				tabData.accept(MintyirlplanetsModBlocks.SUBCONSIUS_FENCE.get().asItem());
				tabData.accept(MintyirlplanetsModBlocks.SUBCONSIUS_FENCE_GATE.get().asItem());
				tabData.accept(MintyirlplanetsModBlocks.SUBCONSIUS_BUTTON.get().asItem());
				tabData.accept(MintyirlplanetsModItems.SUBCONSIUS_BOAT.get());
				tabData.accept(MintyirlplanetsModItems.SUBCONSIUS_CHEST_BOAT.get());
				tabData.accept(MintyirlplanetsModBlocks.SUBCONSIUS_DOOR.get().asItem());
				tabData.accept(MintyirlplanetsModBlocks.SUBCONSIUS_SIGN.get().asItem());
				tabData.accept(MintyirlplanetsModBlocks.SUBCONSIUS_HANGING_SIGN.get().asItem());
	...
	public static final DeferredHolder<CreativeModeTab, CreativeModeTab> MINERALS = REGISTRY.register("minerals",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.mintyirlplanets.minerals")).icon(() -> new ItemStack(MintyirlplanetsModItems.DREAMDROP.get())).displayItems((parameters, tabData) -> {
				...
				tabData.accept(MintyirlplanetsModBlocks.MOON_COAL.get().asItem());
				...
				tabData.accept(MintyirlplanetsModBlocks.GLOWING.get().asItem());
				tabData.accept(MintyirlplanetsModItems.GUSTAVIUM_STUFF.get());
				tabData.accept(MintyirlplanetsModBlocks.STARING_MOON_ROCK.get().asItem());
				tabData.accept(MintyirlplanetsModItems.OPAL.get());
				tabData.accept(MintyirlplanetsModBlocks.METEORITE.get().asItem());
				tabData.accept(MintyirlplanetsModItems.MOLDEDMETEORITE.get());
				tabData.accept(MintyirlplanetsModBlocks.CHLORIC_COAL.get().asItem());
				...
				tabData.accept(MintyirlplanetsModBlocks.CHLORIC_DEMONIC_ORE.get().asItem());
				...
				tabData.accept(MintyirlplanetsModBlocks.CHLORITE.get().asItem());
				tabData.accept(MintyirlplanetsModItems.CHLORITE_SHARD.get());
				tabData.accept(MintyirlplanetsModBlocks.CHLORIC_ADAMANTIUMM_ORE.get().asItem());
				tabData.accept(MintyirlplanetsModBlocks.ROCKY_ALUMINEUM_BLOCK.get().asItem());
				tabData.accept(MintyirlplanetsModBlocks.SHINY_ROCKY_ALUMINEUM_BLOCK.get().asItem());
				tabData.accept(MintyirlplanetsModItems.INSPIRING_ESSENCE.get());
				tabData.accept(MintyirlplanetsModItems.ENDOTHERMIC_DUST.get());
				...
				tabData.accept(MintyirlplanetsModBlocks.ENDOTHERMIA.get().asItem());
	...
	public static final DeferredHolder<CreativeModeTab, CreativeModeTab> FOOD = REGISTRY.register("food",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.mintyirlplanets.food")).icon(() -> new ItemStack(MintyirlplanetsModItems.HELL_FRUIT.get())).displayItems((parameters, tabData) -> {
				tabData.accept(MintyirlplanetsModItems.CHICKEN_NUGGET.get());
	...
	public static final DeferredHolder<CreativeModeTab, CreativeModeTab> MISC = REGISTRY.register("misc",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.mintyirlplanets.misc")).icon(() -> new ItemStack(MintyirlplanetsModItems.THE_MOON.get())).displayItems((parameters, tabData) -> {
				...
				tabData.accept(MintyirlplanetsModItems.BUS_PASS.get());
				tabData.accept(MintyirlplanetsModItems.YOUR_MOTHERS_CREDIT_CARD.get());
				...
				tabData.accept(MintyirlplanetsModItems.WORM_ITEM.get());
