...
public class MintyirlplanetsModFluidTypes {
	...
	public static final DeferredHolder<FluidType, FluidType> GUSTAVIUM_TYPE = REGISTRY.register("gustavium", GustaviumFluidType::new);
	public static final DeferredHolder<FluidType, FluidType> TOXIC_WASTE_TYPE = REGISTRY.register("toxic_waste", ToxicWasteFluidType::new);
}