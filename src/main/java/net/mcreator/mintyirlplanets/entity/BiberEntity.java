...
public class BiberEntity extends AbstractArrow implements ItemSupplier {
	public static final ItemStack PROJECTILE_ITEM = new ItemStack(MintyirlplanetsModItems.FIBER_BALL.get());
	private int knockback = 0;

	public BiberEntity(EntityType<? extends BiberEntity> type, Level world) {
		super(type, world);
	}

	public BiberEntity(EntityType<? extends BiberEntity> type, double x, double y, double z, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public BiberEntity(EntityType<? extends BiberEntity> type, LivingEntity entity, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public static BiberEntity shoot(Level world, LivingEntity entity, RandomSource source) {
		return shoot(world, entity, source, 1.5f, 4, 0);
	}

	public static BiberEntity shoot(Level world, LivingEntity entity, RandomSource source, float pullingPower) {
		return shoot(world, entity, source, pullingPower * 1.5f, 4, 0);
	}

	public static BiberEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		BiberEntity entityarrow = new BiberEntity(MintyirlplanetsModEntities.BIBER.get(), entity, world, null);
	...
	public static BiberEntity shoot(LivingEntity entity, LivingEntity target) {
		BiberEntity entityarrow = new BiberEntity(MintyirlplanetsModEntities.BIBER.get(), entity, entity.level(), null);
