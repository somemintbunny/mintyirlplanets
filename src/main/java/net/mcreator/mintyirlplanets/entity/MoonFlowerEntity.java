...
public class MoonFlowerEntity extends Monster {
	public MoonFlowerEntity(EntityType<MoonFlowerEntity> type, Level world) {
		super(type, world);
		xpReward = 23;
		setNoAi(false);
	}
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(MintyirlplanetsModEntities.MOON_FLOWER.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
