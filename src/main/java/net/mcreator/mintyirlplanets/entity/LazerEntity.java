...
public class LazerEntity extends AbstractArrow implements ItemSupplier {
	public static final ItemStack PROJECTILE_ITEM = new ItemStack(MintyirlplanetsModItems.STRANGE_ENERGY.get());
	...
	public LazerEntity(EntityType<? extends LazerEntity> type, double x, double y, double z, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public LazerEntity(EntityType<? extends LazerEntity> type, LivingEntity entity, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	protected ItemStack getDefaultPickupItem() {
		return new ItemStack(MintyirlplanetsModItems.STRANGE_ENERGY.get());
	}
	...
	public static LazerEntity shoot(Level world, LivingEntity entity, RandomSource source, float pullingPower) {
	...
	public static LazerEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		LazerEntity entityarrow = new LazerEntity(MintyirlplanetsModEntities.LAZER.get(), entity, world, null);
	...
	public static LazerEntity shoot(LivingEntity entity, LivingEntity target) {
		LazerEntity entityarrow = new LazerEntity(MintyirlplanetsModEntities.LAZER.get(), entity, entity.level(), null);
