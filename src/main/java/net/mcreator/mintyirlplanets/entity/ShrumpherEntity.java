...
public class ShrumpherEntity extends Monster {
	public ShrumpherEntity(EntityType<ShrumpherEntity> type, Level world) {
		super(type, world);
		xpReward = 973;
		setNoAi(false);
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(6, new RemoveBlockGoal(MintyirlplanetsModBlocks.DARK_MOON_ROCK.get(), this, 1, (int) 3));
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(MintyirlplanetsModEntities.SHRUMPHER.get(), SpawnPlacementTypes.NO_RESTRICTIONS, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, Mob::checkMobSpawnRules, RegisterSpawnPlacementsEvent.Operation.REPLACE);
	}
