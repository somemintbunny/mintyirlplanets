...
public class ShroompleEntity extends Monster {
	public ShroompleEntity(EntityType<ShroompleEntity> type, Level world) {
		super(type, world);
		xpReward = 23;
		setNoAi(false);
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(9, new TemptGoal(this, 1, (Ingredient.of(MintyirlplanetsModItems.HELL_FRUIT.get())), false));
	}
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(MintyirlplanetsModEntities.SHROOMPLE.get(), SpawnPlacementTypes.NO_RESTRICTIONS, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, Mob::checkMobSpawnRules, RegisterSpawnPlacementsEvent.Operation.REPLACE);
	}
