package net.mcreator.mintyirlplanets.world.features.configurations;
...
public record StructureFeatureConfiguration(Identifier structure, boolean randomRotation, boolean randomMirror, HolderSet<Block> ignoredBlocks, Vec3i offset) implements FeatureConfiguration {
	public static final Codec<StructureFeatureConfiguration> CODEC = RecordCodecBuilder.create(builder -> builder.group(Identifier.CODEC.fieldOf("structure").forGetter(StructureFeatureConfiguration::structure),
