...
public class TheMoonTeleporter {
	...
	public static void registerPointOfInterest(RegisterEvent event) {
		event.register(Registries.POINT_OF_INTEREST_TYPE, registerHelper -> {
			...
			registerHelper.register(ResourceLocation.parse("mintyirlplanets:the_moon_portal"), poiType);
	...
	public Optional<BlockUtil.FoundRectangle> createPortal(BlockPos p_77667_, Direction.Axis p_77668_) {
		...
		BlockState blockstate = MintyirlplanetsModBlocks.THE_MOON_PORTAL.get().defaultBlockState().setValue(NetherPortalBlock.AXIS, p_77668_);
