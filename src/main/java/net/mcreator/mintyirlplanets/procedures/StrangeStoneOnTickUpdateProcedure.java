...
public class StrangeStoneOnTickUpdateProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		...
		if ((world.getBlockState(BlockPos.containing(xcheck, ycheck, zcheck))).getBlock() == MintyirlplanetsModBlocks.HORRID_FUNGUS.get()) {
			{
