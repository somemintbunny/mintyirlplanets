...
public class EyezorRenderer extends HumanoidMobRenderer<EyezorEntity, HumanoidRenderState, HumanoidModel<HumanoidRenderState>> {
	private final Identifier entityTexture = Identifier.parse("mintyirlplanets:textures/entities/eyezor.png");
	...
	@Override
	public void extractRenderState(EyezorEntity entity, HumanoidRenderState state, float partialTicks) {
