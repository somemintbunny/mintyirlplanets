...
public class MixolydianArmorArmor {
	...
	public static void registerItemExtensions(RegisterClientExtensionsEvent event) {
		event.registerItem(new IClientItemExtensions() {
			private final Identifier armorTexture = Identifier.parse("mintyirlplanets:textures/models/armor/mixolydian_layer_1.png");
		...
		event.registerItem(new IClientItemExtensions() {
			private final Identifier armorTexture = Identifier.parse("mintyirlplanets:textures/models/armor/mixolydian_layer_2.png");
