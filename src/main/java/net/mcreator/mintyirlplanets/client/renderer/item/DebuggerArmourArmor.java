...
public class DebuggerArmourArmor {
	...
	public static void registerItemExtensions(RegisterClientExtensionsEvent event) {
		event.registerItem(new IClientItemExtensions() {
			private final Identifier armorTexture = Identifier.parse("mintyirlplanets:textures/models/armor/arm1_layer_1.png");
		...
		event.registerItem(new IClientItemExtensions() {
			private final Identifier armorTexture = Identifier.parse("mintyirlplanets:textures/models/armor/arm1_layer_2.png");
