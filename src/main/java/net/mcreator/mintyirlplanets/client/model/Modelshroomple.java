...
public class Modelshroomple extends EntityModel<LivingEntityRenderState> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("mintyirlplanets", "modelshroomple"), "main");
