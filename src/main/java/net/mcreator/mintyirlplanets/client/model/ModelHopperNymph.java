...
public class ModelHopperNymph extends EntityModel<LivingEntityRenderState> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("mintyirlplanets", "model_hopper_nymph"), "main");
